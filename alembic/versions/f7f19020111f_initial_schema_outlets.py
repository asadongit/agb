"""initial_schema_outlets

Revision ID: f7f19020111f
Revises: 
Create Date: 2026-08-10 11:19:06.184561
...
def upgrade() -> None:
    ...
    sa.Column('flagged_item_ids', sa.JSON(), nullable=False),
