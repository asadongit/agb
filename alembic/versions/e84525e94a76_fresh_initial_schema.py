...
Revision ID: e84525e94a76
Revises: 
Create Date: 2026-09-09 20:52:39.091205
...
def upgrade() -> None:
    ...
    sa.Column('credit_balance', sa.Numeric(precision=10, scale=2), server_default='0.00', nullable=False),
    sa.Column('extra_detail', sa.String(length=1000), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    ...
    sa.Column('unit', sa.String(length=50), server_default='piece', nullable=False),
    sa.Column('alternate_units', sa.JSON(), server_default='[]', nullable=False),
    ...
    sa.Column('phone', sa.String(length=50), nullable=True),
    sa.Column('role', sa.Enum('SUPERADMIN', 'OUTLET_ADMIN', 'MANAGER', 'FLOOR_STAFF', 'CASHIER', 'DELIVERY_BOY', 'STAFF', name='roleenum'), nullable=False),
    ...
    sa.Column('credit_applied', sa.Numeric(precision=10, scale=2), server_default='0.00', nullable=False),
    sa.Column('debit_applied', sa.Numeric(precision=10, scale=2), server_default='0.00', nullable=False),
    sa.Column('credit_awarded', sa.Numeric(precision=10, scale=2), server_default='0.00', nullable=False),
    sa.Column('debt_settled', sa.Numeric(precision=10, scale=2), server_default='0.00', nullable=False),
    sa.Column('credit_cashed_out', sa.Numeric(precision=10, scale=2), server_default='0.00', nullable=False),
    sa.Column('customer_balance', sa.Numeric(precision=10, scale=2), nullable=True),
    ...
    sa.Column('loyalty_discount_inr', sa.Numeric(precision=10, scale=2), server_default='0.00', nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
