...
export type AdminVariant = import("@/types").Variant;

export type AdminMenuItem = import("@/types").MenuItem;

export type AdminOrderItem = import("@/types").OrderItemResponse;

export type AdminOrder = import("@/types").OrderResponse;
