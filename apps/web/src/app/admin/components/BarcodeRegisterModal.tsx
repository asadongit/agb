...
import { Barcode, CheckCircle2, Package, Sparkles, X, Building2, Plus, Search, Percent } from "lucide-react";
...
export function BarcodeRegisterModal({
  ...
  const computedCostNum = parseFloat(totalBilledAmount) > 0 ? (parseFloat(totalBilledAmount) / effStock) : (parseFloat(costPerUnit) || 0);
